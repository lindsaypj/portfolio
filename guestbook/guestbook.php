<?php
    session_start();
    $_SESSION['currentPage'] = "/305/portfolio/guestbook/guestbook.php";
...
<?php
    ...
    // Add login modal
    $cancelLink = "/305/portfolio/guestbook/guestbook.php";
    include("../login/login-modal.php");
?>

        <!-- Guestbook form -->
        <form id="newGuestForm" class="bg-dark bg-opacity-80 rounded-3 shadow px-3 py-4 px-sm-4 px-md-5 py-md-5
         text-white d-inline-block" action="thankyou.php" method="post">
