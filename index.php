                        ...
                        <div class="d-table pe-0 me-lg-4 mt-md-2 mt-lg-0 h-100">
                            <div class="d-table-cell align-middle">
                                ...
                                <p class="indent mb-0">
                                    ...
                                    for a clinic in the Seattle area. We designed the website with a focus on ease of access
                                    and maintainability.
                                </p>
                        ...
                        <div class="d-table pe-0 ms-xl-4 mt-md-2 mt-lg-0 h-100 ease-pad">
                            <div class="d-table-cell align-middle">
                                ...
                                <h2 class="px-5 px-lg-3 fw-normal text-center text-md-start text-lg-center ease-pad">Dealership Website
                                    <a class="text-primary" href="/305/portfolio/demos/bmw/home.html" target="_blank" aria-label="Demo site, BMW Dealership">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="mb-3" viewBox="0 0 16 16">
                                ...
                                <!-- Description -->
                                <p class="indent mb-0">
                                    A project built to show off my new skills using a Bootstrap Layout. While the result is
                                    a bit rough around the edges, I was very happy the result. This was one of the first
                                    sites I was excited to show off.
                                </p>
        ...
        <div class="row mx-0 px-0">
            <div class="col-6 col-md-4 d-flex justify-content-center">
                <div class="d-table mx-auto h-100 ease-pad">
                    ...
                    <a class="text-white d-table-cell align-middle px-4 ease-pad" href="//www.linkedin.com/in/patrick-lindsay-546ba0224/" target="_blank">
